...
Acceso en línea: https://vichehe.github.io/Proyecto-De-Turismo/index.html
...
Estudiante	Alumnos de la especialidad de Turismo (y otros que participen en salidas).	- Ver salidas futuras donde están inscritos.
- Inscribirse en salidas disponibles.
- Consultar el calendario personal.
- Ver detalles básicos de las salidas (sin RUT ni fichas médicas).
- Subir fotos a la galería (si tienen permiso).
Guía / Asistente	Estudiantes de Turismo que lideran o asisten en salidas (pueden ser varios por salida).	- Planificar nuevas salidas (crear rutas, añadir participantes, definir transporte).
- Ver todas las salidas donde participan como guías o asistentes.
- Acceder a los RUT y fichas médicas de los participantes.
- Editar sus propias salidas (fechas, rutas, participantes, etc.).
- Consultar el calendario con sus salidas.
- Subir fotos a la galería y eliminar las propias.
Administrador	Profesores jefes, funcionarios del liceo o estudiantes de Programación que mantienen el sistema.	- Gestionar usuarios (cambiar roles, editar datos, activar/desactivar cuentas).
- Ver todas las salidas del sistema (futuras y pasadas).
- Acceder a toda la información (RUT, fichas médicas, etc.).
- Supervisar y moderar la galería (puede eliminar cualquier publicación).
- Supervisar el correcto funcionamiento del sistema.
🚀 Primeros pasos
1. Acceder al sistema
Abre tu navegador y ve a la dirección: https://vichehe.github.io/Proyecto-De-Turismo/index.html
...
En el menú superior, haz clic en "📋 Planificar Salida".

Completa las secciones en este orden:
...
La salida aparecerá en el Lobby y en el Calendario.
...
Gestionar usuarios
En el menú superior, haz clic en "👑 Panel de Administración".
...
También puedes buscar usuarios por RUT, nombre o apellido.
...
Haz clic en "📅 Calendario" en el menú superior.
